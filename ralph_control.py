...
def isHumidifierOutOfWater(switch): # still not sure if the switch we have will measure mWatts
...
def sendOutOfWaterAlert(): #see line 45
...
# Get home path
home = "home/pi" # expanduser("~")   #assumes that this is in /pi/home? 



# Read settings from XML file
xmlPath = "/home/pi/raspi-rht/ralph_control.xml" #will pre-define characteristics / limits
